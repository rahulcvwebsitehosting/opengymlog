...
on your phone, synced across devices, behind your own username/password login.
...
<br>
![GitHub last commit](https://img.shields.io/github/last-commit/rahulcvwebsitehosting/opengymlog?style=flat-square)
...
### [🌐 Live Demo](https://duartesantos8.github.io/openGym/) · [📖 Docs](docs/SELF_HOSTING.md)

No signup, nothing to install — it runs entirely in your browser on example data.<br>
<sub>There's no server behind the demo, so sync across devices and the admin dashboard only exist in a self-hosted instance.</sub>
...
as a home-screen app, username/password sign-in, offline support, sync across your phone and laptop.

## What's New (Fork by Rahul Shyam)

This fork adds several features requested by the community:

- 🔐 **Username/password authentication** — No more passkey-only login. Create an account with a username and password, or use passkeys if you prefer.
- 🔄 **Mobile app server sync** — The Android APK can now sync with your self-hosted server when signed in.
- 📜 **MIT License** — Changed from AGPL to MIT for maximum flexibility.
- 🏗️ **OIDC-ready architecture** — The auth system is designed to easily integrate with OIDC providers (Authentik, Keycloak, etc.) in the future.
...
- 🔑 **Flexible authentication** — Username/password (primary), passkeys (optional), OIDC-ready for future integration
...
- 📱 **Standalone Android app** — the whole tracker as a sideloadable APK: no account, no server, data on the phone, native workout reminders. Now with **optional server sync** when signed in ([download](https://opengym.duarte-santos.ch))
...
Open **http://localhost:8080**, tap **Create account**, and you're in. First launch downloads
...
- **web/** — a multi-stage image that builds the frontend and serves it with nginx, proxying `/api` to the backend so it's all on **one origin** (required for passkeys)

## Your data

Lives in `./data` on your host: `db.json` (profiles + credentials), `state-<user>.json`
...
WebAuthn (optional) · bcrypt · JWT · exercise data from [hasaneyldrm/exercises-dataset](https://github.com/hasaneyldrm/exercises-dataset).
...
- **[Q&A](https://github.com/rahulcvwebsitehosting/opengymlog/discussions/categories/q-a)** — self-hosting
  help, login trouble, "how do I…".
- **[Ideas](https://github.com/rahulcvwebsitehosting/opengymlog/discussions/categories/ideas)** — features
  worth talking through before anyone writes code.
- **[Show and tell](https://github.com/rahulcvwebsitehosting/opengymlog/discussions/categories/show-and-tell)**
  — your setup, your plan templates, whatever you built on top.
- **[Issues](https://github.com/rahulcvwebsitehosting/opengymlog/issues)** — bugs, and work that's already
  been agreed on.
...
openGym is free and stays free: MIT, no subscription, no paid tier, nothing held back for
sponsors. If it replaced a paid tracker for you and you want to chip in, a star, a bug report or a PR is worth just as much.
...
- **Original openGym** by [Duarte Santos](https://github.com/DuarteSantos8) — https://github.com/DuarteSantos8/openGym
- **This fork** by [Rahul Shyam](https://github.com/rahulcvwebsitehosting) — Civil engineer who codes. Built AI apps, browser games, client sites, and construction tools.
  - Portfolio: [rahulshyam-portfolio.vercel.app](https://rahulshyam-portfolio.vercel.app)
  - LinkedIn: [in/rahulshyamcivil](https://www.linkedin.com/in/rahulshyamcivil)
  - GitHub: [github.com/rahulcvwebsitehosting](https://github.com/rahulcvwebsitehosting)