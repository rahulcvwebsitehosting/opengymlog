...
const P = {
  ...
  note: <><path d="M15.5 3.8h-9.4a1.8 1.8 0 0 0-1.8 1.8v12.8a1.8 1.8 0 0 0 1.8 1.8h12.4a1.8 1.8 0 0 0 1.8-1.8v-9.5l-5.2-5.1Z" /><path d="M10.5 12.5h-5M10.5 15.5h-5M10.5 9.5h-5" /></>,
}
