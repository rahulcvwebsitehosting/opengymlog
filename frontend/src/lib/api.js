...
export async function registerWithPassword(username, name, password, code = '') {
  const res = await api('/api/auth/register', { method: 'POST', body: JSON.stringify({ username, name, password, code }) })
